...
| **NFR3: Portability** | ✅ Compliant | Built with Python 3 and Kivy/KivyMD, fulfilling cross-platform (Windows, Linux, Android, iOS) needs with a single codebase. Configured for **Android Target API Level 36**, 16 KB memory page size alignment (`-Wl,-z,max-page-size=16384`), and automated version code calculation (`> 400`) in GitHub Actions CI/CD (`build-and-release.yml`). |
