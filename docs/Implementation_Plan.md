...
- **Tasks:**
  ...
  - **32 KB Memory Page Size Support:** Configured linker flags (`-Wl,-z,max-page-size=32768`) in CI/CD pipeline (`LDFLAGS` & `P4A_EXTRA_LDFLAGS`) to ensure native `.so` binaries align with 32 KB memory page size standards.
